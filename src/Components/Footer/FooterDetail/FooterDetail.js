...
const FooterDetail = () => {
    ...
    const imgFanPage = 'https://scontent.fhan2-1.fna.fbcdn.net/v/t39.30808-6/262571521_4109397472495802_1348157380051921585_n.jpg?_nc_cat=102&ccb=1-5&_nc_sid=e3f864&_nc_ohc=CHj64cArDaQAX-NyDHm&tn=DOx8keyo6BZyBUDD&_nc_ht=scontent.fhan2-1.fna&oh=00_AT_V08bleKbVJKrghfyUBYHNVgbBeRnpA1ICzMicCXPkXg&oe=6222BD89'
                    ...
                    <div className="w-[1170px]">
                        <div className="w-full flex px-[-10px]">
                            ...
                            <div className="w-[25%] mx-[10px]">
                                ...
                                <a target="_blank" href="https://www.facebook.com/GoriVietnam/" className="mt-[15px] block cursor-pointer">
                                    <img src={imgFanPage} alt='img Fanpage'/>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div className="w-full mt-[30px] cursor-default">
                        <div className="bg-[#333] text-[12px] text-[#fff]">
                            <p className="py-[8px] flex items-center justify-center">
                                Copyright © 2022 Gori VietNam. Powered by ThaiSon
                            </p>
                        </div>
                    </div>
                </div>
